    ...
    <>
      ...
      {step === 1 && (
        <div>
          ...
          <div className={styles.containerCarrinho}>
            ...
            <span className={styles.nomeProduto}>Alface</span>
            <span className={styles.precoProduto}>R$ 1,50</span>
          </div>
          <div className={styles.containerCarrinho}>
            <button className={styles.lixeira}>
              <i className="bi bi-trash" id={styles.lixeira}></i>
            ...
            <span className={styles.nomeProduto}>Cenoura </span>
            <span className={styles.precoProduto}>R$ 1,50</span>
          </div>
        </div>
      )}
      {step === 2 && (
        <div>
          ...
          <button id={styles.btnAlterar}><i className="bi bi-journal-medical"></i> Alterar</button>
          <h5 className={styles.tituloCarrinho}>Tipo de entrega</h5>
          <div className={styles.containerTipoEntrega}>
            <label className={styles.checkboxLabel}>
              <input type="radio" name="Entrega Economica" value="Economica" onClick={handleOptionChange}/> Econîmica (1 a 3 dias)
            </label>
              <p className={styles.precoCkb}>R$ 4,00</p>
          </div>
          <div className={styles.containerTipoEntrega}>
            <label className={styles.checkboxLabel}>
              <input type="radio" name="Entrega Economica" value="Rapida" onClick={handleOptionChange}/> Rápida (máximo 50 minutos)
            </label>
              <p className={styles.precoCkb}>R$ 15,00</p>
          </div>
          <div className={styles.containerTipoEntrega}>
            <label className={styles.checkboxLabel}>
              <input type="radio" name="Entrega Economica" value="Agendada" onClick={handleOptionChange}/> Agendada
            </label>
      ...
      <div className={styles.containerBtn}>
        <button className={styles.btnBack} onClick={() => setStep(step > 1 ? step - 1 : step)}>
          <i className="bi bi-arrow-return-left"></i>
        </button>
        <button className={styles.btnNext} onClick={() => setStep(step < 4 ? step + 1 : step)}>
